...
const checks = [
  [app.includes('APP_VERSION = "0.13.3"') && identify.includes('IDENTIFY_VERSION = "0.13.3"') && html.includes("Pocket Mint v0.13.3"), "v0.13.3 camera controls version"],
  ...
  [html.includes('id="coinCameraGuide"') && html.includes('id="coinCameraZoom"') && html.includes('id="coinCameraFocusRing"') && identify.includes("setCoinCameraZoom") && identify.includes("focusCoinCamera") && identify.includes("openNativeCoinCamera"), "guided circular camera supports zoom, tap focus and native fallback"],
  ...
  [sw.includes("pocket-mint-v0.13.3") && sw.includes("!/^https?") && sw.includes("./icons/character-512.png"), "matching service-worker cache, icon assets and remote image exclusions"],
