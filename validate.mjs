...
const checks = [
  [app.includes('APP_VERSION = "0.13.2"') && identify.includes('IDENTIFY_VERSION = "0.13.2"') && html.includes("Pocket Mint v0.13.2"), "v0.13.2 iPhone camera-input repair version"],
  ...
  [identify.includes("prepareIdentifyPhoto") && identify.includes("decodeIdentifyPhoto") && html.includes('id="identifyReverse" type="file" accept="image/*"') && html.includes('id="identifyReverseCamera" type="file" accept="image/*" capture="environment"') && identify.includes('input.value=""') && identify.indexOf('await loadIdentifyPhoto(side,file)') < identify.indexOf('input.value=""'), "iPhone-safe photo preparation with separate gallery and native-camera inputs"],
  ...
  [html.includes('id="coinCameraGuide"') && html.includes('id="coinCameraNative"') && identify.includes("getUserMedia") && identify.includes("captureGuidedCoin") && identify.includes("openNativeCoinCamera"), "guided circular camera with native-camera fallback"],
  ...
  [sw.includes("pocket-mint-v0.13.2") && sw.includes("!/^https?") && sw.includes("./icons/character-512.png"), "matching service-worker cache, icon assets and remote image exclusions"],
