...
const checks = [
  [html.includes("PHASE 0 · V0.10.2"), "visible v0.10.2 marker"],
  ...
  [sw.includes("pocket-mint-phase0-v0.10.2") && sw.includes("!/^https?"), "matching service-worker cache and remote images excluded from precache"],
