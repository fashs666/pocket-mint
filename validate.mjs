...
const checks = [
  [app.includes('APP_VERSION = "0.13.7"') && identify.includes('IDENTIFY_VERSION = "0.13.7"') && html.includes("Pocket Mint v0.13.7"), "v0.13.7 guided-camera and catalogue version"],
  ...
  [sw.includes("pocket-mint-v0.13.7") && sw.includes("!/^https?") && sw.includes("./icons/character-512.png"), "matching service-worker cache, icon assets and remote image exclusions"],
