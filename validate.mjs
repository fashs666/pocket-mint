...
const checks = [
  [app.includes('APP_VERSION = "0.13.8"') && identify.includes('IDENTIFY_VERSION = "0.13.8"') && html.includes("Pocket Mint v0.13.8"), "v0.13.8 visual foundation version"],
  ...
  [sw.includes("pocket-mint-v0.13.8") && sw.includes("./pm-visual.css") && sw.includes("!/^https?") && sw.includes("./icons/character-512.png"), "matching service-worker cache, visual system, icon assets and remote image exclusions"],
