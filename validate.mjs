...
const required = ["index.html", "styles.css", "progress.css", "app.js", "progress.js", "catalogue.json", "manifest.webmanifest", "sw.js", "icon-192.png", "icon-512.png"];
for (const file of required) await access(path.join(root, file));

const [html, app, progress, sw, manifestText, catalogueText] = await Promise.all([
...
const checks = [
  [html.includes("PHASE 0 · V0.5.0"), "visible v0.5.0 marker"],
  [html.includes('href="progress.css"') && html.includes('src="progress.js"'), "v0.5 progress assets loaded"],
  ...
  [sw.includes("pocket-mint-phase0-v0.5.0"), "matching service-worker cache"],
